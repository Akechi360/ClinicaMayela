  ...
  return (
    <header
      className={`fixed top-3 sm:top-5 right-3 sm:right-5 left-3 sm:left-5 lg:right-5
        ...
        shadow-luxury border border-pure-white/40
    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3 md:gap-5 shrink-0">
        {/* Search — oculto en pantallas muy pequeñas */}
        {showSearch && (
          <div className="hidden sm:flex relative focus-within:ring-1 focus-within:ring-satin-copper/20 rounded-xl bg-pure-white/30 border border-satin-copper/15 px-3 py-1.5 items-center transition-all">
            <input 
              type="text" 
        ...
        <div className="flex items-center gap-0.5 sm:gap-1 border-r border-rose-champagne/80 pr-2 sm:pr-4 shrink-0">
          <button aria-label="Notificaciones" className="text-slate-medium hover:text-satin-copper p-1 sm:p-1.5 rounded-xl hover:bg-pure-white/50 transition-colors cursor-pointer">
            <Bell size={15} />
          </button>
          <button aria-label="Ayuda" className="hidden sm:block text-slate-medium hover:text-satin-copper p-1.5 rounded-xl hover:bg-pure-white/50 transition-colors cursor-pointer">
            <HelpCircle size={15} />
          </button>
        </div>
        ...
        <div className="flex items-center shrink-0">
          {doctor && (
            <Link 
              ...
              className="w-8 h-8 sm:w-9 sm:h-9 rounded-full overflow-hidden border border-satin-copper/20 hover:border-satin-copper shadow-md cursor-pointer transition-all duration-300 hover:scale-105"
            >
              <img 
                alt={doctor.nombre} 
